...
<h2 id="">```</h2>
<h2 id="643-도커-이미지와-컨테이너-생성-및-검사">6.4.3 도커 이미지와 컨테이너 생성 및 검사</h2>
<h3 id="이미지-다운로드-및-컨테이너-생성-방법">이미지 다운로드 및 컨테이너 생성 방법</h3>
<ul>
<li>방법 1. 이미지 다운로드 후 컨테이너 생성</li>
<li>방법 2. 이미지 다운로드와 컨테이너 생성을 한번에 동작시키는 방법<ul>
<li>이미지를 자동으로 다운로드 받은 후 컨테이너를 생성만 하고 안으로 들어가지는 않는다.</li>
</ul>
</li>
<li><code>방법 2</code>에서 생성한 이미지를 이용한 컨테이너</li>
</ul>
<hr />
<h2 id="65-도커-컨테이너와-도커-허브-연동">6.5 도커 컨테이너와 도커 허브 연동</h2>
<h2 id="651-사용자가-생성한-컨테이너를-이용한-이미지-생성">6.5.1 사용자가 생성한 컨테이너를 이용한 이미지 생성</h2>
<ul>
<li>앞에서 작업했던 모든 것들을 제거<h3 id="사전-작업">사전 작업</h3>
</li>
<li>이미지 검색하고 다운로드</li>
<li>컨테이널르 생성한다.</li>
</ul>
...
<ul>
<li>(모듈변수, 클래스, 함수)가 모두 포함되도록 한다.<ul>
<li>모듈 파일</li>
<li>주 파일</li>
</ul>
</li>
...
<hr />
<h3 id="예제-4-사칙연산을-모듈을-사용해서-작성2">예제 4. 사칙연산을 모듈을 사용해서 작성2.</h3>
<ul>
<li>모듈 파일 2개(<code>m21.py</code>, <code>m22,py</code>)로 구성하고 주파일에서 실행</li>
<li>각 모듈 파일에는 1개의 메서드가 있는 클래스 1개와
일반 함수 1개로 구성한다</li>
<li>모듈 파일 <code>m21.py</code>의 클래스의 메서드는 더하기(add)로 하고 일반 함수는 '빼기(sub)'로 구성한다.</li>
<li>모듈 파일 'm22.py'의 클래스의 메서드는 '곱하기(mul)'로 하고 일반 함수는 '나누기(div)'로 구성한다.</li>
</ul>